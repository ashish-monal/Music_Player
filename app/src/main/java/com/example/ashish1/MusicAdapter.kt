...
import com.example.ashish1.databinding.DetailsViewBinding
import com.example.ashish1.databinding.MoreFeaturesBinding
...
class MusicAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        return MyHolder(
            MusicRecyclerviewBinding.inflate(LayoutInflater.from(context), parent, false)
        )
    }
