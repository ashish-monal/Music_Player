...
import com.example.ashish1.databinding.PlaylistViewBinding
...
class PlaylistViewAdapter(
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.delete.setOnClickListener {
            ...
            setDialogBtnBackground(context, customDialogs)
        }
        ...
        if (PlaylistActivity.musicPlaylist.ref[position].playlist.size > 0) {
            Glide.with(context)
                .load(PlaylistActivity.musicPlaylist.ref[position].playlist[0])
